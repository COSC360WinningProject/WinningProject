...
This project will fully implement a reddit-style discussion forum,
from a hand-styled front end using HTML5/CSS and Javascript,
 to a MySQL database and server-side scripting using PHP? (node pls),
and hosted using ???. 
